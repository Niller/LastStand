...
using Assets.External.NGUI.Examples.Scripts.InventorySystem.System;
using UnityEngine;

namespace Assets.External.NGUI.Examples.Scripts.InventorySystem.Game {
    /// <summary>
