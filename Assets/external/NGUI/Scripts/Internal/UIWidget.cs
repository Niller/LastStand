...
public class UIWidget : UIRect
{
	...
	public void CheckLayer ()
	{
		if (panel != null && panel.gameObject.layer != gameObject.layer) {
            /*string format = string.Format("panel.gameObject = {0}.{1} /{4}/  gameObject ={2}.{3} /{5}/,", panel.transform.parent.name, panel.gameObject.name,
                transform.parent.name, gameObject.name,LayerMask.LayerToName(panel.gameObject.layer), LayerMask.LayerToName(gameObject.layer));
			Debug.LogWarning("You can't place widgets on a layer different than the UIPanel that manages them.\n" +
                "If you want to move widgets to a different layer, parent them to a new panel instead.  " + format, this);
             */
	...
	/// <summary>
	/// Virtual Comix0() functionality for widgets.
	/// </summary>
