...
public class UIViewport : MonoBehaviour
{
	...
	void Start ()
	{
        ...
        if (sourceCamera == null || MainCamera == null) {
            if (transform.parent != null)
                sourceCamera = NguiUtils.GetComponentInParents<Camera>(transform.parent.gameObject);
	...
	void LateUpdate ()
	{
		if (topLeft != null && bottomRight != null)
		{
            ...
            if (mCam.orthographicSize != size) mCam.orthographicSize = size * MainCamera.orthographicSize;
		}
	}
}