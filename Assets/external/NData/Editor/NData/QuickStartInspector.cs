...
public class QuickStartInspector : Editor
{
	public override void OnInspectorGUI()
    {
		...
		var viewModelComponent = UnityEngineInternal.APIUpdaterRuntimeServices.AddComponent(gameObject, "Assets/GUI/External/NData/Editor/NData/QuickStartInspector.cs (24,28)", "ViewModel");
